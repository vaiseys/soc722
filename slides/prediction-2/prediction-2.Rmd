...
where $T_i$ is the treatment dummy and $time_{it}$ is the dummy variable that 
indicates whether the observation of unit _i_ is before (0) or after (1) the introduction of the treatment.

--

$\beta_3$ here gives you the **sample average treatment effect on the treated** 
(SATT). That is, what would have happened to the treated cases _because_ they
were treated.
